...
import { adminUserFavoriteChannelParamsSchema, adminUserListQuerySchema, adminUserParamsSchema, createAdminUserBodySchema, resetAdminUserPasswordBodySchema, updateAdminUserBodySchema } from './admin-user.schema.js';
...
adminUserRouter.delete('/:id/favorite-channels/:channelId', validateRequest({ params: adminUserFavoriteChannelParamsSchema }), asyncHandler(controller.removeFavoriteChannel));
