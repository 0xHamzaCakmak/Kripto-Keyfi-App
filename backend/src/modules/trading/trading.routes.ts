...
import { activatePaperFleet, activateTestnet, activateTestnetFleet, archive, arenaStatus, autonomousOverview, capital, closePaperPosition, createPaperBot, generations, liveEligibilityStatus, paperAccounting, pausePaperBot, promotion, resetPaperPnl, resetTestnetAccounting, resumePaperBot, settings, startPaperBot, testnetAccountSummary, testnetBotOperation, testnetOperations, triggerGeneration } from '../ai-trading/autonomous-admin.controller.js';
import { autonomousBotParamsSchema, autonomousGenerationQuerySchema, botCapitalSchema, closePaperPositionSchema, createAutonomousPaperBotSchema, nonCriticalBotSettingsSchema, paperFleetActivationSchema, promotionReviewSchema, resetPaperAccountingSchema, resetTestnetAccountingSchema, testnetActivationSchema, testnetFleetActivationSchema, triggerPaperGenerationSchema } from '../ai-trading/autonomous-admin.schema.js';
...
tradingRouter.get('/autonomous/paper-accounting', asyncHandler(paperAccounting));
tradingRouter.post('/autonomous/paper-accounting/reset', validateRequest({ body: resetPaperAccountingSchema }), asyncHandler(resetPaperPnl));
...
tradingRouter.post('/autonomous/testnet-fleet/activate', validateRequest({ body: testnetFleetActivationSchema }), asyncHandler(activateTestnetFleet));
tradingRouter.post('/autonomous/paper-fleet/activate', validateRequest({ body: paperFleetActivationSchema }), asyncHandler(activatePaperFleet));
...
tradingRouter.post('/autonomous/bots/:id/close-paper-position', validateRequest({ params: autonomousBotParamsSchema, body: closePaperPositionSchema }), asyncHandler(closePaperPosition));
