...
ALTER TABLE `trading_bot_paper_fills`
  ...
  ADD CONSTRAINT `trading_bot_paper_fills_decisionId_fkey` FOREIGN KEY (`decisionId`) REFERENCES `trading_bot_decisions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE `shadow_trades`
  DROP FOREIGN KEY `shadow_trades_decisionId_fkey`,
  MODIFY `decisionId` BIGINT UNSIGNED NULL,
  ADD CONSTRAINT `shadow_trades_decisionId_fkey` FOREIGN KEY (`decisionId`) REFERENCES `trading_bot_decisions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
