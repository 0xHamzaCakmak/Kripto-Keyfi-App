...
function formatSubscriberCount(value: number | null) {
  return value === null ? 'Abone verisi bekleniyor' : `${new Intl.NumberFormat('tr-TR').format(value)} abone`;
}
