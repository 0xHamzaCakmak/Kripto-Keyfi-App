...
export function OpenPositionsPage() {
  ...
  const [profileForm, setProfileForm] = useState<TradingExecutionProfile>({ minLeverage: 5, maxLeverage: 20, botAllocationUsdt: '500', minInitialMarginUsdt: '100', maxOrderNotional: '2000', maxInitialMargin: '500', maxAccountOpenNotional: '10000', stopLossBps: 300, takeProfitBps: 100, maxOrdersPerMinute: 60, entryPaused: false });
