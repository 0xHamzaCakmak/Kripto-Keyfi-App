  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-5 xl:grid-cols-[1.1fr_.9fr]">
      <article className="rounded-[28px] border border-outline/10 bg-surface p-6">
        ...
        <Link to="/admin/trading/ai-pro?tab=exchange-accounts" className="mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-black text-background">Borsa hesaplarını yönet <ArrowRight size={17}/></Link>
      </article>
