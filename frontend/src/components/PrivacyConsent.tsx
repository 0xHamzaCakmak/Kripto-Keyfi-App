...
export default function PrivacyConsent() {
  ...
  return <aside role="dialog" aria-label="Ölçüm tercihi" className="fixed bottom-16 left-4 right-4 z-[80] mx-auto max-w-3xl rounded-2xl border border-primary/25 bg-[#11110f]/95 p-4 shadow-2xl backdrop-blur md:flex md:items-center md:gap-5">
    <p className="text-sm leading-6 text-on-surface-variant"><strong className="text-white">Gizlilik odaklı ölçüm:</strong> Haber deneyimini iyileştirmek için yalnızca anonim etkileşim ve Core Web Vitals verileri tutulur. Kullanıcı kimliği, IP adresi, arama metni ve tam URL kaydedilmez.</p>
