...
const sections = [
  ...
  { id: 'kontroller', title: '5. Başlat, durdur ve acil durdurma', items: [
    ['Üstteki DEMO Otomatik İşlemleri Aç/Durdur', 'Seçili DEMO / TESTNET hesabının entryPaused kontrolünü değiştirir. Backend yalnızca bu hesaptaki arşivlenmemiş DEMO AUTONOMOUS botlarını günceller; PAPER ve LIVE botlarına dokunmaz. Risk ve Arena aynı DEMO hesap ayarını kullanır.'],
