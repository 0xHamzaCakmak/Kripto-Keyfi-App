...
export const ManagementNavigation: React.FC<ManagementNavigationProps> = ({
  ...
  const mainTabs = [
    ...
    { id: 'risk' as MainTabType, label: 'Risk / Bot Ayarları', icon: ShieldAlert },
    ...
    <div className="w-full space-y-3">
      ...
      <div className="w-full bg-[#0b0e11]/95 border-b border-[#2b3139] px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center flex-wrap gap-2">
          <nav aria-label="Site ve yönetim bağlantıları" className="flex flex-wrap items-center gap-2">
            <Link to="/" className="inline-flex items-center gap-1.5 rounded-lg border border-[#2b3139] bg-[#1e2329] px-3 py-1.5 text-xs font-semibold text-[#eaecef] transition-colors hover:border-[#f0b90b] hover:text-[#f0b90b] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#f0b90b]">
              <Home className="h-3.5 w-3.5" aria-hidden="true" />
              <span>Siteye Dön</span>
            </Link>
            <Link to="/admin" className="inline-flex items-center gap-1.5 rounded-lg border border-[#2b3139] bg-[#1e2329] px-3 py-1.5 text-xs font-semibold text-[#eaecef] transition-colors hover:border-[#f0b90b] hover:text-[#f0b90b] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#f0b90b]">
          ...
          <button
            ...
            title="Yalnızca seçili DEMO / TESTNET hesabının otomatik işlem ve pozisyon yönetimini duraklatır veya sürdürür."
          ...
          >
            ...
            <span>{isBotsRunning ? 'DEMO İşlemleri Durdur' : 'DEMO İşlemleri Aç'}</span>
          </button>
